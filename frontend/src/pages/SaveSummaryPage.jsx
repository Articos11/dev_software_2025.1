...
export default function SaveSummaryPage() {
  ...
  // Recebe texto e ajustes da navegação anterior, com fallback padrão
  const { texto = "Nenhum resumo recebido.", ajustes = {}, promptAdicional = "" } = location.state || {};

  // Estado para texto editável
        ...
        <CardBox className="max-w-[400px]">
          ...
          <div className="w-full flex flex-col items-center gap-2 justify-center mt-5">
            <button
              ...
              className="bg-[var(--color-resumeai-teal)] text-white font-semibold px-3 py-2 w-50 rounded-full hover:bg-teal-500 shadow-sm"
            >
              Salvar Resumo
            </button>
